...
private: // nested structs
    ...
    public: // members
        Pointer left, right;
    public: // method
        Node_base(Pointer const &left, Pointer const &right):
            left(left), right(right) { }

        Node_base():
            Node_base(nullptr, nullptr) { }

        Node_base(Node_base const& other):
            Node_base(other.left, other.right) { }

        void set_field(Pointer left_sptr, Pointer right_sptr) { //NB move to trash
            left = left_sptr;
            right = right_sptr;
        }
    ...
    public: // members
        T data;
    public: //method
        Node(T const& data, Pointer const &left, Pointer const &right):
             Node_base(left, right), data(data) { }
...
public: // method of perset
    persistent_set(): _size(0) {
        root = end_node = Pointer(new Node_base());
    }
